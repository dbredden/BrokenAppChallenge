    ...
    public class ProgramUI
    {
        ...
        private void AddPokemonToTeam()
        {
            ...
            else
            {
                ...
                newPokemon.PokemonSpeciesName = species;

                Console.WriteLine("Pokemon Nick Name: ");
                string name = Console.ReadLine();
                newPokemon.PokemonNickName = name;

                Console.WriteLine("Pokemon Level: (Enter a digit between 1-100)");
                ...
                else
                {
                    ...
                    newPokemon.PokemonType = typeOne;
